...
There is no endpoint here for marking a day either. Which sets were mobility
work is a field on the set, written through the normal workout routes, and the
day follows from them (d7e4f2a91b83).
"""
